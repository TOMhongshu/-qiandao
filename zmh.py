...
if login_json['id'] != "":
    ...
    returnsLogs = returnsLogs + '\n' + "开始执行评论任务>>>"
    for i in range(3):
        newPost_resp = requests.get(url="https://zhutix.com/pc/page/" + str(random.randint(1, 37)) + "/", stream=True, verify=False)
        ...
        comments_head = {
            ...
            "Origin": "https://zhutix.com",
            "Referer": newPost_url}
        comments_resp = requests.post(url=comments_url, data=comments_data, headers=comments_head, stream=True, verify=False)
